...
public class Menus extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {buscar, delete, entrar, jButton1});
    ...
    private void entrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_entrarActionPerformed
        ...
        if ("".equals(placa.getText()) || "".equals(document.getText()) || "".equals(name.getText()) || "".equals(numero.getText())) {
            JOptionPane.showMessageDialog(rootPane, "Alguno de los Campos se Encuentra Vacio");
        } else {
            if (op.validarListFull()) {
                JPanel[] array = {p1, p2, p3, p4, p5, p11, p13, p21, p22, p24};

                if (op.validatePlate(placa.getText())) {
    ...
    private void buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarActionPerformed
        ...
        if (op.validarListNull()) {
            op.search(JOptionPane.showInputDialog("Ingrese la Placa"));
        }
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        if (op.validarListNull()) {
            JPanel[] array2 = {p1, p2, p3, p4, p5, p11, p13, p21, p22, p24};
            int pos = Integer.parseInt(JOptionPane.showInputDialog("Ingrese la Posicion"));
            
            if (pos <= 10 & pos >= 1) {
                if (array2[pos].getBackground() != Color.green) {
                    array2[pos - 1].setBackground(Color.green);
                    op.eliminarAuto(pos);
                } else {
                    JOptionPane.showMessageDialog(rootPane, "No hay un Auto en el Lugar Indicado");
                }
            } else {
                JOptionPane.showMessageDialog(rootPane, "Lugar No Existente");
            }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (!op.validarListFull()) {
            ...
            JOptionPane.showMessageDialog(rootPane, "Quedan " + (10 - op.calcularSize()) + " espacios Disponibles");
        }
